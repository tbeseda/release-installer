...
describe('Archive Extraction', () => {
  test('extractArchive identifies tar.gz files', async () => {
    ...
    try {
      ...
      // Expected to fail with tar command error
      assert.match(error.message, /tar command failed|Failed to extract/);
    }
  ...
  test('extractArchive identifies zip files', async () => {
    ...
    try {
      ...
      assert.match(error.message, /unzip command failed|Failed to extract/);
    }
